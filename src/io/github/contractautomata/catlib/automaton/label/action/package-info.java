 ...
 * Actions can have an <tt>Address</tt>, in this case implementing the interfacet <tt>AddressedAction</tt>.
 ...
 * the other partners and an orchestrator is in charge of pairing offers and requests. <br>
 */
