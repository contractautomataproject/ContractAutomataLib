...
//
//	public static ModalAutomaton<CALabel> composition(List<ModalAutomaton<CALabel>> aut, Predicate<ModalTransition<List<State<String>>,List<String>,CAState,CALabel>> pruningPred, Integer bound)
//	{
...
//			ModalTransition<List<State<String>>,List<String>,CAState,CALabel> tra;
//			Integer ind;
//			public FMCATransitionIndex(ModalTransition<List<State<String>>,List<String>,CAState,CALabel> tr, Integer i) {
...
//		Set<ModalTransition<List<State<String>>,List<String>,CAState,CALabel>> tr = new HashSet<ModalTransition<List<State<String>>,List<String>,CAState,CALabel>>();//transitions of the composed automaton to build
...
//				Map<ModalTransition<List<State<String>>,List<String>,CAState,CALabel>, List<Entry<ModalTransition<List<State<String>>,List<String>,CAState,CALabel>,List<CAState>>>> matchtransitions=
...
//									
//									ModalTransition<List<State<String>>,List<String>,CAState,CALabel> tradd=new ModalTransition<List<State<String>>,List<String>,CAState,CALabel>(sourcestate,
...
//
//									return Stream.of((Entry<ModalTransition<List<State<String>>,List<String>,CAState,CALabel>, Entry<ModalTransition<List<State<String>>,List<String>,CAState,CALabel>,List<CAState>>>) 
//											Map.entry(e.tra, Map.entry(tradd,targetlist)),
//											(Entry<ModalTransition<List<State<String>>,List<String>,CAState,CALabel>, Entry<ModalTransition<List<State<String>>,List<String>,CAState,CALabel>,List<CAState>>>)//dummy, ee.tra is matched
...
//				Set<Entry<ModalTransition<List<State<String>>,List<String>,CAState,CALabel>,List<CAState>>> trmap=
//						trans2index.parallelStream()
...
//												new ModalTransition<List<State<String>>,List<String>,CAState,CALabel>(sourcestate,  
...
//									mapping((Entry<ModalTransition<List<State<String>>,List<String>,CAState,CALabel>, List<CAState>> e)-> e.getKey(),toSet()), 
//									mapping((Entry<ModalTransition<List<State<String>>,List<String>,CAState,CALabel>, List<CAState>> e)-> e.getValue(),toSet()), 
//									(trans,toVis)->{
