 ...
 *
 */
public class CompositionSpecCheck implements BiPredicate<List<Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>>>,Automaton<String,Action,State<String>,ModalTransition<String, Action,State<String>,CALabel>>>{

	@Override
	public boolean test(List<Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>>> aut, Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>> comp) {
	...
	private boolean rank(List<Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>>> aut, Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>> comp)
	{
	...
	private boolean states(List<Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>>> aut,
	...
	private boolean finalStates(List<Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>>> aut,
								Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>> comp)
	{
		return compareStatesPred(State::isFinalState,comp,aut);
	}

	private boolean compareStatesPred(Predicate<State<String>> pred, Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>> comp, List<Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>>> aut) {
	...
	private boolean initialState(List<Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>>> aut, Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>> comp)
	{
	...
	private boolean transitions(List<Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>>> aut, Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>> comp) {

		//true if the source of transition t (of the operand at index ind)  is a component of composite state s
		TriPredicate<ModalTransition<String,Action,State<String>,CALabel>,Integer,State<String>> sourcestatepred= (t,ind,s)->
		...
		List<Set<ModalTransition<String,Action,State<String>,CALabel>>> autTr = aut.stream()
	 ...
	 * 
	 */
	private Predicate<ModalTransition<String,Action,State<String>,CALabel>> predMatch(List<Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>>> aut,
																					  Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>> comp,
		...
		TriPredicate<ModalTransition<String,Action,State<String>,CALabel>,ModalTransition<String,Action,State<String>,CALabel>,
		ModalTransition<String,Action,State<String>,CALabel>> modalitymatchpred = (t,ti,tj) ->((t.getModality().equals(ModalTransition.Modality.PERMITTED) && ti.getModality().equals(ModalTransition.Modality.PERMITTED) &&
	 ...
	 *
	 */
	private Predicate<ModalTransition<String,Action,State<String>,CALabel>> predIntrleav(List<Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>>> aut,
																						 Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>> comp,
			TriPredicate<ModalTransition<String,Action,State<String>,CALabel>,Integer,State<String>> sourcestatepred,
			List<Set<ModalTransition<String,Action,State<String>,CALabel>>> autTr){
	...
	private int shift(List<Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>>> aut, int j) {
