...
// *
// */
//public class ChoreographySynthesisOperatorOld implements UnaryOperator<ModalAutomaton<CALabel>> {
//
...
//	
//	public ChoreographySynthesisOperatorOld(Predicate<CALabel> req){
//		this.req=req;
//	}
//	
//	public ChoreographySynthesisOperatorOld(Predicate<CALabel> req, 
...
//
//		synth=new ModelCheckingSynthesisOperator((x,st,bad) -> isUncontrollableChoreography(x,st, bad),req,prop);
//		synth.setPruningPred((x,t,bad) -> violatingbc.contains(x.toCSV()),req);
//		
