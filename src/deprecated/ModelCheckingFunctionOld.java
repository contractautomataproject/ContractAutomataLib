...
// *
// */
//public class ModelCheckingFunctionOld implements 
...
//
//	public ModelCheckingFunctionOld() {
...
//	 */
//	public ModelCheckingFunctionOld(Integer bound) {
//		this.bound=bound;
//	}
//
//	/**
...
//		ModalAutomaton<Label<List<String>>> convprop = ModelCheckingFunctionOld.convert(prop, Label::new, ModalTransition::new, ModalAutomaton::new);
//
...
//				(ModalAutomaton<Label<List<String>>>) cf.apply(bound);
//
//		if (comp==null)
//			return null;
//		
