...
public class ITChoreographyTest {
	...
	public void chorTestLMCS2020Transitions() throws Exception {
		// boolean check=false;
		Automaton<String,Action, State<String>, ModalTransition<String,Action,State<String>,CALabel>> aut = bdc.importMSCA(ITAutomatonTest.dir+ "(ClientxPriviledgedClientxBrokerxHotelxHotel).data");
		List<Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>>> tests = new ArrayList<>();
		tests.add(bdc.importMSCA(ITAutomatonTest.dir+ "Chor_(ClientxPriviledgedClientxBrokerxHotelxHotel).data"));
		int max=8;
		//	while(true){
		max+=1;
		//			System.out.println(max);
		for (int i=1;i<max;i++)
			tests.add(bdc.importMSCA(ITAutomatonTest.dir+"Chor_(ClientxPriviledgedClientxBrokerxHotelxHotel)_"+i+".data"));
		...
		boolean check = tests.stream()
				.anyMatch(a-> ITAutomatonTest.autEquals(cor,a));
		//				corsave=cor;
	...
	public void chorTestLMCS2020TransitionsConstructorTwoArguments() throws Exception {
		Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>> aut = bdc.importMSCA(ITAutomatonTest.dir+ "(ClientxPriviledgedClientxBrokerxHotelxHotel).data");
		Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>> test = bdc.importMSCA(ITAutomatonTest.dir+ "Chor_(ClientxPriviledgedClientxBrokerxHotelxHotel)_5.data");
	...
	{
		Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>> aut = bdc.importMSCA(ITAutomatonTest.dir+ "test_chor_controllablelazyoffer.data");
		Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>> test = bdc.importMSCA(ITAutomatonTest.dir+ "Chor_(test_chor_controllablelazyoffer).data");
		assertTrue(ITAutomatonTest.autEquals(new ChoreographySynthesisOperator<String>(new StrongAgreement()).apply(aut),test));
	}
	...
	{
		Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>> aut = bdc.importMSCA(ITAutomatonTest.dir+ "test_lazy_empty_cor.data");
	...
	{
		Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>> aut = bdc.importMSCA(ITAutomatonTest.dir+ "test_chor_urgentoffer.data");
		Assert.assertNull( new ChoreographySynthesisOperator<String>(new StrongAgreement()).apply(aut));
	}
	...
	public void choreoConcur2021ex25() throws Exception {
		Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>> aut = bdc.importMSCA(ITAutomatonTest.dir+ "testcor_concur21_Example25.data");
	...
	public void choreoConcur2021ex34() throws Exception {
		Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>> aut = bdc.importMSCA(ITAutomatonTest.dir+ "testcor_concur21_Example34.data");
		boolean bc = aut.getTransition().stream()
				.allMatch(t->new ChoreographySynthesisOperator<String>(new StrongAgreement()).satisfiesBranchingCondition(t,aut.getTransition(),
						new HashSet<>()));
		Assert.assertFalse(bc);	
	...
	public void branchingCondition() throws NumberFormatException, IOException {
		Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,CALabel>> aut = bdc.importMSCA(ITAutomatonTest.dir+ "violatingbranchingcondition.data");
	...
	public void testCorSynthesis2021() throws IOException {
		...
		Automaton<String,Action,State<String>,ModalTransition<String, Action,State<String>,CALabel>> test = bdc.importMSCA(ITAutomatonTest.dir+ "Cor_(testcor_concur21_Example34)_prop.data");
