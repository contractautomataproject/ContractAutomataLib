...
public class Snippets {
	...
	{
		ModalAutomaton<CALabel> aut = new DataConverter().importMSCA(dir+"(BusinessClientxHotelxEconomyClient).data");		
	...
	{
		ModalAutomaton<CALabel> aut = new DataConverter().importMSCA(dir+"(BusinessClientxHotelxEconomyClient).data");
		ModalAutomaton<CALabel> aut2 = new DataConverter().importMSCA(dir+"BusinessClientxHotel_open.data");
