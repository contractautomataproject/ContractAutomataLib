...
public class ModelCheckingTest {
	...
	public void testModelCheckingLoopMc() throws IOException {
		Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,Label<Action>>> aut = adc.importMSCA(dir + "modelchecking_loop.data");
	...
	public void testForte2021mc() throws IOException {
		Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,Label<Action>>> aut = adc.importMSCA(dir + "(AlicexBob)_forte2021.data");
		mcf = new ModelCheckingFunction<>(aut,prop,  State::new, ModalTransition::new, Label::new,Automaton::new);
	...
	public void testLazyLoopMc() throws IOException {
		Automaton<String,Action,State<String>,ModalTransition<String, Action,State<String>,Label<Action>>> aut = adc.importMSCA(dir + "test_lazy_loop_prop.data");
		mcf = new ModelCheckingFunction<>(aut,prop,  State::new, ModalTransition::new, Label::new,Automaton::new);
		Automaton<String,Action,State<String>,ModalTransition<String,Action,State<String>,Label<Action>>> comp = mcf.apply(Integer.MAX_VALUE);
