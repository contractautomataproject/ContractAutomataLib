...
Several operations for  for composing automata, for computing the union, 
for synthesising an orchestration, choreography, or most permissive controller 
are extending corresponding functional interfaces that are using the class MSCA 
for performing the various operations. 
Below is the class diagram of the package automatically generated by Sparx Enterprise Architect.
