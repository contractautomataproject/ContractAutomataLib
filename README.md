...
In this example the Family is generated independently from the automaton, and both are paired 
into an FMCA. An orchestration of a product of the family is computed.
